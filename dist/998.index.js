...
exports.ids = [998];
exports.modules = {
  /***/ 2041: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
  ...
  /***/ 1308: /***/ (__unused_webpack_module, exports) => {
    Object.defineProperty(exports, "__esModule", { value: true });
  ...
  /***/ 2054: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        this.middlewareStack.use(
          core.getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
            httpAuthSchemeParametersProvider:
              httpAuthSchemeProvider.defaultSSOHttpAuthSchemeParametersProvider,
    ...
    const paginateListAccountRoles = core.createPaginator(
      SSOClient,
      ListAccountRolesCommand,
      "nextToken",
      "nextToken",
    ...
    const paginateListAccounts = core.createPaginator(
      SSOClient,
      ListAccountsCommand,
      "nextToken",
      "nextToken",
  ...
  /***/ 7523: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    var protocolHttp = __webpack_require__(2356);
    var core = __webpack_require__(402);
    ...
    const resolveSSOCredentials = async ({
      ...
      const { SSOClient, GetRoleCredentialsCommand } =
        await Promise.resolve().then(function () {
          return __webpack_require__(6553);
        });
      const sso =
        ssoClient ||
        new SSOClient(
          Object.assign({}, clientConfig ?? {}, {
            ...
            userAgentAppId:
              ...
              parentClientConfig?.userAgentAppId,
          }),
        );
      let ssoResp;
      try {
      ...
      async ({ callerClientConfig } = {}) => {
        ...
        if (
          ...
          if (profile?.sso_session) {
            const ssoSessions =
              await sharedIniFileLoader.loadSsoSessionData(init);
  ...
  /***/ 6553: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
  ...
  /***/ 5433: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    var client = __webpack_require__(5152);
    ...
    const fromEnvSigningName =
      ({ logger, signingName } = {}) =>
      async () => {
        logger?.debug?.("@aws-sdk/token-providers - fromEnvSigningName");
        if (!signingName) {
          throw new propertyProvider.TokenProviderError(
            "Please pass 'signingName' to compute environment variable key",
            { logger },
          );
        }
        const bearerTokenKey =
          httpAuthSchemes.getBearerTokenEnvKey(signingName);
    ...
    const fromSso =
      ...
      async ({ callerClientConfig } = {}) => {
        ...
        try {
          ssoToken =
            await sharedIniFileLoader.getSSOTokenFromFile(ssoSessionName);
        } catch (e) {
          throw new propertyProvider.TokenProviderError(
    ...
    const nodeProvider = (init = {}) =>
      propertyProvider.memoize(
        propertyProvider.chain(fromSso(init), async () => {
          throw new propertyProvider.TokenProviderError(
