...
exports.ids = [360];
exports.modules = {
  /***/ 5360: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      if (profiles[profileName]) {
        ...
        if (credentialProcess !== undefined) {
          const execPromise = util.promisify(
            sharedIniFileLoader.externalDataInterceptor?.getTokenRecord?.()
          ...
          try {
            ...
            throw new propertyProvider.CredentialsProviderError(error.message, {
              logger,
            });
          }
        } else {
