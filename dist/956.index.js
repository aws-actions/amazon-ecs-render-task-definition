...
exports.ids = [956];
exports.modules = {
  /***/ 8079: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const fromTokenFile =
      ...
      async (awsIdentityProperties) => {
        ...
        const credentials = await (0, fromWebToken_1.fromWebToken)({
          ...init,
          webIdentityToken:
            shared_ini_file_loader_1.externalDataInterceptor?.getTokenRecord?.()[
      ...
      if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } =
          await Promise.resolve().then(() =>
            __importStar(__webpack_require__(1136)),
          );
  ...
  /***/ 9956: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
