...
exports.modules = {
  /***/ 3723: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    class STSClient extends smithy_client_1.Client {
      ...
      constructor(...[configuration]) {
        const _config_0 = (0, runtimeConfig_1.getRuntimeConfig)(
          configuration || {},
        );
        super(_config_0);
        ...
        const _config_2 = (0, middleware_user_agent_1.resolveUserAgentConfig)(
          _config_1,
        );
        ...
        const _config_6 = (0, middleware_endpoint_1.resolveEndpointConfig)(
          _config_5,
        );
        const _config_7 = (0,
        httpAuthSchemeProvider_1.resolveHttpAuthSchemeConfig)(_config_6);
        ...
        this.middlewareStack.use(
          (0, core_1.getHttpAuthSchemeEndpointRuleSetPlugin)(this.config, {
            httpAuthSchemeParametersProvider:
              httpAuthSchemeProvider_1.defaultSTSHttpAuthSchemeParametersProvider,
  ...
  /***/ 4532: /***/ (__unused_webpack_module, exports) => {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.resolveHttpAuthRuntimeConfig =
      exports.getHttpAuthExtensionConfiguration = void 0;
  ...
  /***/ 7851: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    Object.defineProperty(exports, "__esModule", { value: true });
  ...
  /***/ 6811: /***/ (__unused_webpack_module, exports) => {
    Object.defineProperty(exports, "__esModule", { value: true });
  ...
  /***/ 1136: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const AssumeRoleWithWebIdentityRequestFilterSensitiveLog = (obj) => ({
      ...
      ...(obj.WebIdentityToken && {
        WebIdentityToken: smithyClient.SENSITIVE_STRING,
      }),
    });
    ...
    const de_Credentials = (output, context) => {
      ...
      if (output[_E] != null) {
        contents[_E] = smithyClient.expectNonNull(
          smithyClient.parseRfc3339DateTimeWithOffset(output[_E]),
        );
      }
      return contents;
    };
    ...
    const throwDefaultError =
      smithyClient.withBaseException(STSServiceException);
    ...
    const buildFormUrlencodedString = (formEntries) =>
      Object.entries(formEntries)
        .map(
          ([key, value]) =>
            smithyClient.extendedEncodeURIComponent(key) +
            "=" +
            smithyClient.extendedEncodeURIComponent(value),
        )
        .join("&");
    ...
    class AssumeRoleCommand extends smithyClient.Command.classBuilder()
    ...
    class AssumeRoleWithWebIdentityCommand extends smithyClient.Command.classBuilder()
      .ep(EndpointParameters.commonParams)
      .m(function (Command, cs, config, o) {
        return [
          middlewareSerde.getSerdePlugin(
    ...
    const getDefaultRoleAssumer = (stsOptions = {}, stsPlugins) =>
      getDefaultRoleAssumer$1(
        stsOptions,
        getCustomizableStsClientCtor(STSClient.STSClient, stsPlugins),
      );
    ...
    const decorateDefaultCredentialProvider = (provider) => (input) =>
      provider({
        ...
        httpAuthSchemes: config?.httpAuthSchemes ?? [
          {
            ...
            identityProvider: (ipc) =>
              ...
              (async (idProps) =>
                await config.credentialDefaultProvider(
                  idProps?.__config || {},
                )()),
  ...
  /***/ 7742: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const resolveRuntimeExtensions = (runtimeConfig, extensions) => {
      const extensionConfiguration = Object.assign(
        ...
        (0, protocol_http_1.getHttpHandlerExtensionConfiguration)(
          runtimeConfig,
        ),
        (0, httpAuthExtensionConfiguration_1.getHttpAuthExtensionConfiguration)(
          runtimeConfig,
        ),
      );
      ...
      return Object.assign(
        ...
        (0, smithy_client_1.resolveDefaultRuntimeConfig)(
          extensionConfiguration,
        ),
        (0, protocol_http_1.resolveHttpHandlerRuntimeConfig)(
          extensionConfiguration,
        ),
